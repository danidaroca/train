...
public class billetes {
    ...
    // comprar2: muestra el menu de compra y llama a una función diferente por cada
    // opcion seleccionada
    public static void comprar() {
        ...
        do {
            userError = false;
            System.out.println(
                    "¿Cuántos billetes desea comprar? Recuerde que deberá comprar al menos 1 billete y que quedan "
                            + asientos.countFree() + " disponibles");
            numBilletes = Scanner.nextInt();
            if (numBilletes > asientos.countFree() || numBilletes <= 0) {
                System.out.println(
                        "El numero de billetes de ser mayor que 0 y menor o igual al numero de asientos libres("
                                + asientos.countFree() + ")");
                userError = true;
            }
        } while (userError);
        do {
            userError = false;
            System.out.println(
                    "¿Cuántos billetes son para menores? Recuerde que al menos un adulto debe acompañar a los viajeros menores de edad");
            billetesMenores = Scanner.nextInt();
            if (billetesMenores > numBilletes) {
                System.out.println(
                        "Error, el numero de billetes para menores no puede ser mayor al numero de billetes solicitado.");
                userError = true;
    ...
    // manual: pregunta al usuario la informacion necesaria y reserva asientos uno a
    // uno
        ...
        do {
            do {
                ...
                if (!Errores.IsValidRow(row)) {
                    System.out.println(
                            "El número de fila del asiento debe ser mayor que 0 y menor o igual al numero de filas del tren");
                    userError = true;
                }
            } while (userError);
            do {
                ...
                if (!Errores.IsValidCol(col)) {
                    System.out.println(
                            "El número de columna del asiento debe ser mayor que 0 y menor o igual al numero de columnas del tren");
                    userError = true;
                }
            } while (userError);
    ...
    public static void change() {
        ...
        do {
            ...
            if (billetesCambiar > asientos.countFree() || billetesCambiar <= 0) {
                System.out.println(
                        "El numero de billetes que desea cambiar debe ser mayor que 0 y menor o igual al numero de asientos libres("
                                + asientos.countFree() + ")");
                userError = true;
            } else if (billetesCambiar > asientos.countReserved()) {
                userError = true;
                System.out.println(
                        "Error, el número de billetes que desea cambiar debe ser menor o igual al número de asientos reservados ");
            }
        } while (userError);
        ...
        do {
            ...
            do {
                ...
                if (!Errores.IsValidRow(toRow)) {
                    System.out.println(
                            "El número de columna del asiento debe ser mayor que 0 y menor o igual al numero de filas del tren");
                    userError = true;
                }
            } while (userError);
            ...
            do {
                ...
                if (!Errores.IsValidCol(toCol)) {
                    System.out.println(
                            "El número de fila del asiento debe ser mayor que 0 y menor o igual al numero de columnas del tren");
                    userError = true;
                }
            } while (userError);
